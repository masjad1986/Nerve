    ...
    public class JobController : Controller
    {
        ...
        public async Task<IActionResult> JobAllocationAsync(int? id)
        {
            try
            {
                ...
                var allocations = await _jobService.GetPendingJobAllocationByLocationAsync(defaultLocation, jobAllocationViewModel.JobAllocation.EngineerCode);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (jobAllocationViewModel.ShowTodayJobs)
                        allocations = await _jobService.GetPendingJobAllocationByDateAsync(jobAllocationViewModel.JobAllocation.LocationCode,
                                                                               jobAllocationViewModel.JobAllocation.EngineerCode, DateTime.Now);
                    else
                        allocations = await _jobService.GetPendingJobAllocationByLocationAsync(jobAllocationViewModel.JobAllocation.LocationCode,
                                                                               jobAllocationViewModel.JobAllocation.EngineerCode, jobAllocationViewModel.ShowPendingJobs);
                    jobAllocationViewModel.JobAllocations = allocations;
