...
namespace Nerve.Repository
{
    public class DeviceRepository : IDeviceRepository
    {
        ...
        {
            var query = $@"SELECT 1 AS [Pending] FROM [HAMI_DATA].[dbo].[vwnrv_jobs] j 
             ...
             */
                ...
                query = $@"INSERT INTO [{RepositoryConstants.SchemaName}].[{SCP.TransactionTables.DealerLog}]
                    ...
                    (
	                    ...
	                    @product,@brand,TRIM(@model)),@customer_name,@last_name, @mobile_number,
	                    ...
	                    @locationname,@servicecenter,@location_code, @loc,@detailid,@fault_code, 
                ...
                parameters.Add(new SqlParameter { ParameterName = "@brand", Value = deviceDto.Brand });
                parameters.Add(new SqlParameter { ParameterName = "@model", Value = deviceDto.Model });
                ...
                parameters.Add(new SqlParameter { ParameterName = "@locationname", Value = deviceDto.LocationName });
                ...
                parameters.Add(new SqlParameter { ParameterName = "@detailid", Value = deviceDto.DetailId });
                parameters.Add(new SqlParameter { ParameterName = "@fault_code", Value = deviceDto.FaultCode });
                parameters.Add(new SqlParameter { ParameterName = "@fault_details", Value = deviceDto.FaultDetail });
                ...
                query = $@"INSERT INTO [{RepositoryConstants.SchemaName}].[{SCP.TransactionTables.AccessoriesDetail}] (trackingno,accessoryid,deleted)";
                //append values from DeviceDto.AccessoryList
